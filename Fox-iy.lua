...
Title.TextSize = 18
Title.Text = "Fox X Infinite Yield FE v" .. currentVersion
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		inviteButton.Text = "Copy QQ Invite Link (1007072905)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'QQ / support / help', DESC = 'FOX STUDIO交流群.'}
...
addcmd('QQ', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('1007072905')
		notify('QQ Invite', 'Copied to clipboard!\n 1007072905')
	else
		notify('QQ Invite', '1007072905')
	end
	if httprequest then
		httprequest({
